  ...
  return (
    <div className="mx-[25%] font-opensans">
      ...
      <p>
        ...
        using the personal information described in this Privacy Policy depends
        on the Personal Information we collect and the specific context in which
      ...
      <ul>
        ...
        <li>
          You have given Nutrition and Health Monitoring System permission to do
          so
        </li>
        <li>
      ...
      <p>
        ...
        this Privacy Policy. We will retain and use your information to the
      ...
      <p>
        ...
        advertisements and links that appear on nhms, which are sent directly to
