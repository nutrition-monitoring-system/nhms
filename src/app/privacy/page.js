...
export default function Home() {
  return (
    <>
      <div className="w-1/2 m-auto font-opensans">
        ...
        <p>
          ...
          collected and recorded by nhms and how we use it.
        </p>
        ...
        <p>
          Nutrition and Health Monitoring System legal basis for collecting and
        ...
        <ul>
          <li>
            Nutrition and Health Monitoring System needs to perform a contract
            with you
          </li>
          <li>
            You have given Nutrition and Health Monitoring System permission to
            do so
          </li>
          <li>
            Processing your personal information is in Nutrition and Health
            Monitoring System legitimate interests
          </li>
          <li>
            Nutrition and Health Monitoring System needs to comply with the law
          </li>
        </ul>

        <p>
          Nutrition and Health Monitoring System will retain your personal
        ...
        <h2 className="text-lg text-center font-bold">Log Files</h2>
        ...
        <p>
          Like any other website, nhms uses "cookies". These cookies are used to
        ...
        <h2 className="text-lg text-center font-bold">Privacy Policies</h2>

        <p>
          You may consult this list to find the Privacy Policy for each of the
          advertising partners of nhms.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on nhms, which are sent directly
        ...
        <p>
          Note that nhms has no access to or control over these cookies that are
        ...
        <p>
          nhms's Privacy Policy does not apply to other advertisers or websites.
        ...
        <p>
          ...
          shared and/or collect in nhms. This policy is not applicable to any
          information collected offline or via channels other than this website.
        </p>

        <h2 className="text-lg text-center font-bold">Consent</h2>
