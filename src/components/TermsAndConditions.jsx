export default function TermsAndConditions({ onClick, handleClickPrev }) {
  return (
    <div className="min-w-full rounded-md flex-1 bg-black overflow-hidden">
      {/* <TermsTemplate /> */}
      <div className="w-full p-4 flex justify-around items-center">
        <button className="tile" onClick={handleClickPrev}>
          Decline
        </button>
...
export function Terms() {
  return (
    <div className="m-auto w-1/2 sm:w-3/4 font-opensans">
      <TermsTemplate />
    </div>
  );
}
  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>Reproduce, duplicate or copy material from nhms</li>
      ...
      <p>
        ...
        reflect the views and opinions of Nutrition and Health Monitoring
        System,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Nutrition and Health Monitoring System
