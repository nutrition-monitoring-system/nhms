...
export default function User({ handsignOut }) {
  ...
  return (
    <div className="body grid grid-rows-1 grid-cols-4">
      <SideNavBar></SideNavBar>
      <div className="grid grid-cols-1 gap-1 grid-rows-5 col-span-3 overflow-hidden">
        <MiniNavBar
          avatar={avatar}
...
function MiniNavBar({ avatar, handleAvatarChange, confirmLogout }) {
  ...
  return (
    <div className="grid grid-cols-2 shadow-md gap-3 justify-center items-center bg-gray-100 px-6 py-3">
...
function SideNavBar() {
  ...
  return (
    <div className="sidebar flex flex-col justify-start items-center py-4 bg-black">
      {/* 添加搜索框 */}

      {/* 你的导航链接 */}
      <div className="sticky top-0  bg-black grid grid-cols-1 gap-2 w-full h-screen px-5">
        <Logo></Logo>
        <Link
          href="/blog"
...
function Log() {
  return (
    <div className="shadow-md bg-gray-100 rounded-md log flex justify-center items-center gap-4">
...
function CreateHealthRecordForm() {
  ...
  return (
    <div className="Creat rounded-md shadow-md bg-gray-100 flex justify-center items-center gap-4">
